...
{
    public abstract class DataConfiguratorCollectionBase<TData, TContext> : IDataConfiguratorCollection<TData>
    {
        ...
        protected abstract void Configure(MutatorsContext context, MutatorsConfigurator<TData, TContext> configurator);
            ...
            if (slot == null)
            {
                lock (lockObject)
                {
                    ...
                    if (slot == null)
                    {
                        ...
                        Configure(context, new MutatorsConfigurator<TData, TContext>(root));
