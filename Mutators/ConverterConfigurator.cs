...
namespace GrobExp.Mutators
{
    public class ConverterConfigurator<TSource, TDest, TContext>
    {
        ...
        {
            return new ConverterConfigurator<TSource, TDest, TContext>(reporter, Root);
        }
        ...
        {
            return new ConverterConfigurator<TSource, TSource, TDest, TDest, TValue, TContext>(reporter, Root, source => source, dest => dest, pathToValue, Condition);
        }
        ...
        {
            return new ConverterConfigurator<TSource, TSource, TDest, TChild, TChild, TContext>(reporter, Root, source => source, pathToChild, pathToChild, Condition);
        }
        ...
        {
            return new ConverterConfigurator<TSource, TSourceChild, TDest, TDestChild, TDestChild, TContext>(reporter, Root, pathToSourceChild, pathToDestChild, pathToDestChild, Condition);
        }

        public ConverterConfigurator<TSource, TDest, TContext> If(LambdaExpression condition)
        {
            return new ConverterConfigurator<TSource, TDest, TContext>(reporter, Root, Condition.AndAlso((LambdaExpression)condition.ExcludingContextParameter<TContext>().ReplaceEachWithCurrent()));
        }
    ...
    public class ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, TDestValue, TContext>
    {
        ...
        {
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, TDestValue, TContext>(reporter, Root, PathToSourceChild, PathToChild, PathToValue, null);
        }
        ...
        {
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, T, TContext>(reporter, Root, PathToSourceChild, PathToChild, PathToValue.Merge(pathToValue), Condition);
        }
        ...
        public ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, T, T, TContext> GoTo<T>(Expression<Func<TDestChild, T>> pathToChild)
        {
            ...
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, T, T, TContext>(reporter, Root, PathToSourceChild, path, path, Condition);
        }
        ...
        public ConverterConfigurator<TSourceRoot, T2, TDestRoot, T1, T1, TContext> GoTo<T1, T2>(Expression<Func<TDestChild, T1>> pathToDestChild, Expression<Func<TSourceChild, T2>> pathToSourceChild)
        {
            ...
            return new ConverterConfigurator<TSourceRoot, T2, TDestRoot, T1, T1, TContext>(reporter, Root, PathToSourceChild.Merge(pathToSourceChild), path, path, Condition);
        }
        ...
        {
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, TDestValue, TContext>(reporter, Root, PathToSourceChild, PathToChild, PathToValue, Condition.AndAlso((LambdaExpression)PathToSourceChild.Merge(condition).ReplaceEachWithCurrent()));
        }
        ...
        {
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, TDestValue, TContext>(reporter, Root, PathToSourceChild, PathToChild, PathToValue, Condition.AndAlso((LambdaExpression)condition.MergeFrom2Roots(PathToSourceChild, PathToChild).ReplaceEachWithCurrent()));
        }
        ...
        {
            var withoutContext = (Expression<Func<TSourceChild, TDestChild, bool?>>) condition.ExcludingContextParameter<TContext>();
            return new ConverterConfigurator<TSourceRoot, TSourceChild, TDestRoot, TDestChild, TDestValue, TContext>(Root, PathToSourceChild, PathToChild, PathToValue, Condition.AndAlso((LambdaExpression)withoutContext.MergeFrom2Roots(PathToSourceChild, PathToChild).ReplaceEachWithCurrent()));
        }

        public ConverterConfigurator<TSourceRoot, TDestRoot, TContext> ToRoot()
        {
            return new ConverterConfigurator<TSourceRoot, TDestRoot, TContext>(reporter, Root, Condition);
        }
